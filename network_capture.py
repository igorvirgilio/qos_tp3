...
class network_capture(object):
    ...
    def __init__(self, *args):
        # Types of errors to grab in output interface 
        self.keywords = ['error', 'get', 'ssl', 'https', 'http']
        ...
        typesource = "-i"
        typeexit = "enp0s3"
        self.capture_cmd = "sudo tcpdump " + typesource + " " + typeexit
    ...
    def validate_interface(self, interface):
        ...
        fd = fcntl.ioctl(unix_socket.fileno(),
                         SIOCGIFFLAGS, interface + null256)
    ...
    def main(self):
        #source = ['network_capture.py', '-i', 'enp0s3', '-keys', 'error,get,ssl,https']
